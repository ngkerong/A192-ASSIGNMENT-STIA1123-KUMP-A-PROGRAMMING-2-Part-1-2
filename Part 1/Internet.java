        ...
        do{    
            ...
            switch (category) {
                ...
                case 2:
                    ...
                    System.out.println(wifi2.display() + wifi2.special("Wired"));
                    
                    break;
                case 3:
                
                    System.out.println(wifi3.display() + wifi3.special("Wireless"));
                    
                    break;
                default:
                    
                    System.out.println(wifi4.display() + wifi4.special("Wireless"));
